...
[![Build Status](https://github.com/AlexandrePhilibert/http-swagger/actions/workflows/ci.yml/badge.svg?branch=master)](https://github.com/features/actions)
[![Codecov branch](https://img.shields.io/codecov/c/github/AlexandrePhilibert/http-swagger/master.svg)](https://codecov.io/gh/AlexandrePhilibert/http-swagger)
[![Go Report Card](https://goreportcard.com/badge/github.com/AlexandrePhilibert/http-swagger)](https://goreportcard.com/report/github.com/AlexandrePhilibert/http-swagger)
[![GoDoc](https://godoc.org/github.com/AlexandrePhilibert/http-swagger?status.svg)](https://godoc.org/github.com/AlexandrePhilibert/http-swagger)
[![Release](https://img.shields.io/github/release/AlexandrePhilibert/http-swagger.svg?style=flat-square)](https://github.com/AlexandrePhilibert/http-swagger/releases)
...
swag init
```
4. Download [http-swagger](https://github.com/AlexandrePhilibert/http-swagger) by using:
```sh
go get -u github.com/AlexandrePhilibert/http-swagger
```
And import following in your code:

```go
import "github.com/AlexandrePhilibert/http-swagger" // http-swagger middleware
```
...
import (
	...
	"github.com/AlexandrePhilibert/http-swagger/v2"
	_ "github.com/AlexandrePhilibert/http-swagger/example/go-chi/docs" // docs is generated by Swag CLI, you have to import it.
)
...
import (
	...
	"github.com/go-chi/chi"
	"github.com/AlexandrePhilibert/http-swagger/v2"
	_ "github.com/AlexandrePhilibert/http-swagger/example/go-chi/docs"
)
